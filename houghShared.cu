...
int main(int argc, char **argv)
{
  ...
  // llamada al kernel
  GPU_HoughTranShared<<<gridDim, blockDim>>>(d_in, w, h, d_hough, rMax, rScale, d_Cos, d_Sin);

  // terminar tiempo de ejecucion
  ...
  // guarda la imagen
  inImg->saveImg("Shared.jpeg", lines, radInc, rBins);
